...
const Hero = () => {
  ...
  return (
    <div
      className="max-container flex flex-col xl:flex-row gap-12 
    pt-24 "
    >
      <div className="lg:w-3/5 ">
        ...
        <h1
          className="text-[56px] max-sm:leading-tight md:text-[85px]
        sm:text-7xl xl:text-8xl text-light font-semibold mt-8 font-palanquin "
        >
          Master Your Learning with{" "}
          <span className=" text-primary ">Cryptic Cards</span>
        </h1>
